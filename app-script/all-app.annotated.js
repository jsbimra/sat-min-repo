...
(function() {
 ...
 ;(function(){
	'use strict';
		...
		parentController.$inject = ['$scope', '$http', '$location', '$timeout', '$routeParams', 'dataservice', 'appFactory'];
	angular.module('satApplication')
 ...
 ;(function(){
	...
	mainController.$inject = ['$scope', '$http', '$location', '$timeout', 'appFactory', '$routeParams', '$rootScope', '$route'];
	angular.module('satApplication')
...
/*
 ...
 ;(function(){
	'use strict';
		...
		questionnaireMethod.$inject = ['$timeout'];
	angular.module('satApplication')
 ...
 ;(function(){
	'use strict';
		...
		landingController.$inject = ['$scope', '$http', '$location', 'appFactory'];
	angular.module('satApplication')
 ...
 ;(function(){
	'use strict';
		...
		instructionController.$inject = ['$scope', '$http', '$location', '$timeout', 'appFactory'];
	angular.module('satApplication')
 ...
 ;(function(){
	'use strict';
		...
		lawAndRegulationsController.$inject = ['$scope', '$http', '$location', 'dataservice', '$timeout', 'appFactory', 'lawJSONPath'];
	angular.module('satApplication')
 ...
 ;(function(){
	'use strict';
		...
		organizationController.$inject = ['$scope', '$http', '$location', 'dataservice', '$timeout', 'appFactory', '$routeParams', 'orgJSONPath'];
	angular.module('satApplication')
 ...
 ;(function(){
	'use strict';
		...
		cultureController.$inject = ['$scope', '$http', '$location', 'dataservice', '$timeout', 'appFactory', '$routeParams', 'cultJSONPath'];
	angular.module('satApplication')
 ...
 ;(function(){
	'use strict';
		...
		techniekController.$inject = ['$scope', '$http', '$location', 'dataservice', '$timeout', 'appFactory', '$routeParams', 'techJSONPath'];
	angular.module('satApplication')
 ...
 ;(function(){
	...
	resultController.$inject = ['$scope', '$http', '$location', 'dataservice', '$timeout', 'renderChart', 'appFactory', '$routeParams', 'constServiceBaseURL'];
	angular.module('satApplication')
 ...
 ;(function(){
	'use strict';
		...
		bestPractisesController.$inject = ['$scope', '$http', '$location', 'dataservice', '$timeout', '$routeParams', 'appFactory'];
	angular.module('satApplication')
